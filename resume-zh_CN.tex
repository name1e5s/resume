...
\end{onehalfspacing}
\begin{itemize}
  \item \textbf{99} \quad 计算导论与程序设计课程设计
  \item \textbf{95} \quad 数据结构课程设计、计算机网络课程设计、形式语言与自动机、离散数学(上)
  \item \textbf{92} \quad 计算机网络、计算机系统基础
  \item \textbf{90} \quad 数据库系统原理、算法设计与分析、计算机组成原理
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  \item 外国语言：CET-4\ \textbf{541} \quad CET-6\ \textbf{510}
  \item 编程语言:
        \begin{itemize}
