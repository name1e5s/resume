...
\begin{onehalfspacing}
  ...
  \begin{itemize}
    ...
    \item 从零开始自行设计的五级流水线双发射 MIPS32 微处理器，主频 100 MHz。
          ...
          教学用操作系统，理论上能够运行完整的 Linux 操作系统。处理器性能较高，初赛性能分排名\textbf{第二}
  \end{itemize}
\end{onehalfspacing}
...
\begin{itemize}[parsep=0.5ex]
  \item 编程语言:
        \begin{itemize}
          \item \textbf{熟悉}\quad C、Go、C++、System Verilog、Swift
          \item \textbf{了解}\quad Python、Chisel、Rust、TypeScript、Bash、Java
        \end{itemize}
  \item Linux 中国 (https://linux.cn) 译者之一，译作曾为该站微信公众号 2018 年度阅读量第一
\end{itemize}
